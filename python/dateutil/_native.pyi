"""Type stubs for the Rust native extension module (dateutil-core via dateutil-py)."""
...
EASTER_JULIAN: Final[Literal[1]]
EASTER_ORTHODOX: Final[Literal[2]]
EASTER_WESTERN: Final[Literal[3]]
_EasterMethod: TypeAlias = Literal[1, 2, 3]

def easter(year: int, method: _EasterMethod = EASTER_WESTERN) -> datetime.date: ...
...
class isoparser:
    ...
    def isoparse(self, dt_str: str | bytes) -> datetime.datetime: ...
    def parse_isodate(self, datestr: str | bytes) -> datetime.date: ...
    def parse_isotime(self, timestr: str | bytes) -> datetime.time: ...
    def parse_tzstr(
        self, tzstr: str | bytes, zero_as_utc: bool = True
    ) -> datetime.tzinfo: ...
...
class relativedelta:
    ...
    def __init__(
        self,
        dt1: datetime.datetime | datetime.date | None = None,
        dt2: datetime.datetime | datetime.date | None = None,
        years: int = 0,
        months: int = 0,
        days: int = 0,
        weeks: int = 0,
    ...
    @staticmethod
    def from_diff(
        dt1: datetime.datetime | datetime.date,
        dt2: datetime.datetime | datetime.date,
    ) -> relativedelta: ...
    def add_to_datetime(
        self,
    ...
    @overload
    def __add__(self, other: datetime.date) -> datetime.date | datetime.datetime: ...
    @overload
    def __radd__(self, other: datetime.datetime) -> datetime.datetime: ...
    @overload
    def __radd__(self, other: datetime.date) -> datetime.date | datetime.datetime: ...
    def __sub__(self, other: relativedelta) -> Self: ...
    @overload
    def __rsub__(self, other: datetime.datetime) -> datetime.datetime: ...
    @overload
    def __rsub__(self, other: datetime.date) -> datetime.date | datetime.datetime: ...
...
class rrule:
    ...
    def __init__(
        ...
        byweekday: (
            int | _Weekday | list[int | _Weekday] | tuple[int | _Weekday, ...] | None
        ) = None,
    ...
    def count(self) -> int: ...
    @overload
    def __getitem__(self, index: int) -> datetime.datetime: ...
    @overload
    def __getitem__(self, index: slice) -> list[datetime.datetime]: ...
...
class tzoffset(datetime.tzinfo):
    ...
    def __init__(
        self,
        name: str | None = None,
        offset: int | datetime.timedelta = 0,
    ) -> None: ...
    def utcoffset(self, dt: datetime.datetime | None = None) -> datetime.timedelta: ...
    def dst(self, dt: datetime.datetime | None = None) -> datetime.timedelta: ...
    def tzname(self, dt: datetime.datetime | None = None) -> str: ...
...
class tzfile(datetime.tzinfo):
    ...
    def utcoffset(  # type: ignore[override]
        self, dt: datetime.datetime | None = None, fold: bool = False
    ) -> datetime.timedelta: ...
    def dst(  # type: ignore[override]
        self, dt: datetime.datetime | None = None, fold: bool = False
    ) -> datetime.timedelta: ...
    def tzname(  # type: ignore[override]
        self, dt: datetime.datetime | None = None, fold: bool = False
    ) -> str: ...
    def is_ambiguous(self, dt: datetime.datetime) -> bool: ...
    def fromutc(self, dt: datetime.datetime) -> datetime.datetime: ...

...
fn bench_relativedelta(c: &mut Criterion) {
    ...
    c.bench_function("relativedelta_add_months", |b| {
        let delta = RelativeDelta::new(
            0, 3, 0, 0, 0, 0, 0, 0, None, None, None, None, None, None, None, None, None, None,
        )
        .unwrap();
        b.iter(|| {
    ...
    c.bench_function("relativedelta_add_complex", |b| {
        let wd = Weekday::new(4, Some(2)).unwrap(); // 2nd Friday
        let delta = RelativeDelta::new(
            1, 2, 3, 0, 4, 30, 15, 500_000, None, None, None, Some(wd), None, None, None, None,
            None, None,
        )
        .unwrap();
        b.iter(|| {

...
@pytest.mark.tzoffset
@pytest.mark.skipif(
    not SUPPORTS_SUB_MINUTE_OFFSETS, reason="Sub-minute offsets not supported"
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            marks=[
                pytest.mark.skipif(False, reason="bytes arguments accepted in Python 2")
            ],
        ),
        pytest.param(
            object(),
            ...
            marks=[
                pytest.mark.xfail(
                    reason="AttributeError instead of TypeError", raises=AttributeError
                ),
            ],
        ),
    ],
...
class TZRangeTest(unittest.TestCase, TzFoldMixin):
    ...
    def testRangeInequalityUnsupported(self):
        ...
        self.assertTrue(ComparesEqual == TZR)
        self.assertFalse(ComparesEqual != TZR)
...
class TZStrTest(unittest.TestCase, TzFoldMixin):
    ...
    def testStrInequalityUnsupported(self):
        ...
        self.assertTrue(ComparesEqual == TZS)
        self.assertFalse(ComparesEqual != TZS)
...
class TzWinTest(unittest.TestCase, TzWinFoldMixin):
    ...
    def testTzWinInequalityUnsupported(self):
        ...
        EST = tz.tzwin("Eastern Standard Time")
        self.assertTrue(ComparesEqual == EST)
        self.assertFalse(ComparesEqual != EST)

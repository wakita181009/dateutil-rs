...
class TestEasterBindings:
    def test_returns_date_not_datetime(self):
        from dateutil_rs import easter
...
class TestRelativeDeltaBindings:
    def test_construction_simple(self):
        from dateutil_rs import relativedelta
    ...
    def test_weekday_positive(self):
        from dateutil_rs import MO, relativedelta
    ...
    def test_weekday_negative(self):
        from dateutil_rs import FR, relativedelta
    ...
    def test_weekday_object_form(self):
        from dateutil_rs import MO, relativedelta
...
class TestTopLevelImports:
    def test_easter(self):
        from dateutil_rs import EASTER_WESTERN, easter

        assert easter(2024, EASTER_WESTERN) == date(2024, 3, 31)

    def test_weekday(self):
        from dateutil_rs import MO, weekday

        assert str(MO) == "MO"
        assert str(weekday(0, 1)) == "MO(+1)"

    def test_relativedelta(self):
        from dateutil_rs import FR, MO, relativedelta
